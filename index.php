...
// $_SERVER['REQUEST_URI'] contiene la URI completa (por ejemplo, "/daw/practica_dawpr7/registro").
// parse_url() extrae solo la parte del path, ignorando la consulta (?).
$request_uri = parse_url($_SERVER['REQUEST_URI'], PHP_URL_PATH);
// Limpia la URI eliminando la parte '/daw/practica_dawpr7' de la ruta y los caracteres de barra iniciales o finales.
$request_uri = trim(str_replace('/daw/practica_dawpr7', '', $request_uri), '/');
...
$routes = [
    ...
    'mis-albumes'=>'views/mis_albumes.php',
    'mis-fotos'=>'views/mis_fotos.php',
