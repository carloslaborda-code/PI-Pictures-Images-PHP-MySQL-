    ...
    items.sort((a, b) => {
        ...
        switch (criterio) {
            case "titulo":
                ...
                break;
            case "fecha":
                // Convierte la fecha en formato dd/mm/yyyy a un objeto Date en milisegundos para una comparación numérica
                valorA = convertirFecha(a.querySelector("p:nth-of-type(2)")?.textContent.split(": ")[1] || "");
                valorB = convertirFecha(b.querySelector("p:nth-of-type(2)")?.textContent.split(": ")[1] || "");
                break;
            case "autor":
                ...
                break;
            case "pais":
                // Obtiene el país asociado a la foto (cuarto <p> dentro de cada <li>)
                valorA = a.querySelector("p:nth-of-type(4)")?.textContent.split(": ")[1] || "";
                valorB = b.querySelector("p:nth-of-type(4)")?.textContent.split(": ")[1] || "";
                break;
            default:
        ...
        if (criterio === "titulo" || criterio === "autor" || criterio === "pais") {
...
// Función auxiliar para convertir una fecha en formato dd/mm/yyyy a milisegundos
function convertirFecha(fecha) {
    const [dia, mes, año] = fecha.split("/"); // Divide la fecha en día, mes y año
    return new Date(`${año}-${mes}-${dia}`).getTime(); // Crea un objeto Date en formato yyyy-mm-dd y lo convierte a milisegundos
}
